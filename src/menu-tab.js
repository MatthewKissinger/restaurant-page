...
const menuContent = function(){
    ...
    card1.innerHTML= `<div class="menuItem-container">
                        ...
                        <img class="menu-icon" src="/dist/images/tea-cup-tea-svgrepo-com.svg">`;
    ...
    card2.innerHTML= `<div class="menuItem-container">
                        ...
                        <img class="menu-icon" src="/dist/images/cocktail.svg">`;
    ...
    card3.innerHTML= `<div class="menuItem-container">
                        ...
                        <img id="bloodwine" class="menu-icon" src="/dist/images/wine-glass.svg">`;
